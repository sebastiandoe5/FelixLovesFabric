...
$(document).ready(function() {
    const categoryURL = `https://crossrun.herokuapp.com/https://openapi.etsy.com/v2/shops/FelixLovesFabric/sections/` + getURLParameter('q') + `?api_key=buepssvdyz0dclpg4nnn7caf`;
    ...
    const listingsURL = `https://crossrun.herokuapp.com/https://openapi.etsy.com/v2/shops/FelixLovesFabric/sections/` + getURLParameter('q') + `/listings?api_key=buepssvdyz0dclpg4nnn7caf&includes=Images`;
